    ...
    <script>
        ...
        function playIntro() {
            ...
            videoIntro.play().then(() => {
                ...
                // Jika tidak bisa diputar, langsung skip
                skipIntro();
            });
        ...
        function checkPhoneExists(phoneNumber) {
            return new Promise((resolve) => {
                const ref = database.ref('locations/' + phoneNumber);
        ...
        function startTracking(phoneNumber) {
            ...
            if (locationListener) {
                const oldRef = database.ref('locations/' + currentPhone);
            ...
            checkPhoneExists(phoneNumber).then((exists) => {
                if (!exists) {
        ...
        console.log('🎬 Video Background Login: baground_utama.mp4 (NO SOUND)');
